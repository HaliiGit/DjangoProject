...
from .models import Pojisteny, Pojisteni, UzivatelManager, Uzivatel, PojisteniPojisteny, Udalosti
...
admin.site.register(Pojisteny)
admin.site.register(Pojisteni)
admin.site.register(PojisteniPojisteny)
admin.site.register(Uzivatel, UzivatelAdmin)
admin.site.register(Udalosti)